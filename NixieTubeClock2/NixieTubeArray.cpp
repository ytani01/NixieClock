...
NixieTubeDigit *NixieTube::get_nx_digit(uint8_t digit_i) {
  return &(this->_nx_digit[digit_i]);
}

uint8_t NixieTube::get_blightness(uint8_t digit_i) {
  return this->_nx_digit[digit_i].get_blightness();
}
...
NixieTube *NixieTubeArray::get_nx_tube(uint8_t tube_i) {
  return &(_nx_tube[tube_i]);
}
...
uint8_t NixieTubeArray::get_tube_blightness(uint8_t tube_i, uint8_t digit_i) {
  return this->_nx_tube[tube_i].get_blightness(digit_i);
}
